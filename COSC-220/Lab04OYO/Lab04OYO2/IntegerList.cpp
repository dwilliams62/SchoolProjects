...
{
    cout << "Entering Assignment Statement" << endl;
	delete[] list;
...
{
    cout << "The [] operator is being used on the element number: " << sub << endl;
...
const IntegerList IntegerList::operator+(const IntegerList &right)
{
    cout << "The + operator is being entered" << endl;
    ...
    cout << "The + operator is being exited" << endl;
    return newList;
}
